...
wb1 = openpyxl.load_workbook(r'C:\Users\stock\OneDrive\share\集計転記\自動集計s\仮2022年12月上旬_入在有_パート1.xlsx')
wb1ws = wb1.worksheets[0]

wb2 = openpyxl.load_workbook(r'C:\Users\stock\OneDrive\share\集計転記\syuukeiin.xlsx')
...
wb2.save(r'C:\Users\stock\OneDrive\share\集計転記\syuukeiin.xlsx')
wb1.close()
wb2.close()
